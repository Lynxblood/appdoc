...
CREATE TABLE `document_access` (
  ...
  `document_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `access_level` enum('view','edit','comment') NOT NULL,
...
INSERT INTO `document_access` (`access_id`, `document_id`, `user_id`, `access_level`, `granted_by_user_id`, `granted_at`) VALUES
(2, 44, 8, 'view', 1, '2025-10-13 15:45:50');
...
(70, 45, 'submitted', 'endorsed', 16, NULL, NULL, '2025-10-01 14:50:21', 'ADVW92QR-5e98fa9ff9'),
(71, 52, 'draft', 'submitted', 1, NULL, NULL, '2025-10-13 21:56:52', NULL);
...
INSERT INTO `events` (`event_id`, `organization_id`, `title`, `description`, `start_date`, `end_date`, `location`, `total_expenses`, `created_at`, `updated_at`, `updated_by`) VALUES
(11, 1, 'Futures thinking Developments', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi aut quo molestiae incidunt nam sapiente eos eaque aperiam. Explicabo, soluta.', '2025-10-12 09:00:00', '2025-10-13 17:00:00', 'FTC', 0.00, '2025-09-30 16:49:26', '2025-10-14 10:38:29', 1),
(12, 2, 'fsc', 'sdfasd', '2025-10-17 09:00:00', '2025-10-02 17:00:00', 'sfc', 0.00, '2025-10-01 09:39:34', '2025-10-12 21:25:25', NULL),
(13, 1, 'fu', 'ffff', '2025-10-07 09:00:00', '2025-10-07 17:00:00', 'ftc', 8987.00, '2025-10-11 17:56:16', '2025-10-12 21:25:25', NULL),
(14, 1, 'asdadsssssssssssssssssssssss', 'Loremasdknadgaida', '2025-10-29 09:00:00', '2025-10-30 17:00:00', 'ftc', 988678.00, '2025-10-12 21:31:42', '2025-10-12 22:25:50', 1),
(15, 1, 'asdasd', 'asdasd', '2025-10-22 22:49:39', '2025-10-16 22:49:44', 'asdads', 54656.00, '2025-10-12 22:42:20', '2025-10-12 22:42:20', NULL),
(16, 1, 'asdasd', 'asdasd', '2025-10-23 22:49:00', '2025-10-17 22:49:00', 'asdads', 54656.00, '2025-10-12 22:50:35', '2025-10-12 22:51:02', 1),
(17, 1, 'asda', 'asd', '2025-10-14 09:00:00', '2025-10-15 17:00:00', 'ftc', 5.00, '2025-10-13 21:49:25', '2025-10-13 21:49:25', NULL),
(18, 1, 'asdad', 'asdads', '2025-10-14 09:00:00', '2025-10-15 17:00:00', 'ftc', 8.00, '2025-10-13 21:52:35', '2025-10-13 21:53:00', 1);
...
(75, 1, 44, 'A new comment has been added to your document by dean.', 1, '2025-09-30 16:55:55'),
...
(79, 1, 44, 'A new comment has been added to your document by fssc.', 1, '2025-09-30 16:58:54'),
(80, 16, 44, 'A new document has been submitted for your approval.', 1, '2025-09-30 16:59:04'),
...
(83, 17, 45, 'A new document titled \'dsh.pdf\' has been submitted for your review.', 0, '2025-10-01 14:50:21'),
(84, 16, 52, 'A new document has been submitted for your approval.', 0, '2025-10-13 21:56:52');
...
(1, 'Builders_of Information Technology Society', 'academic', 'img/logo/1_68daaf88b9f33.png'),
(2, 'Sampleorg', 'academic', NULL);
...
--
-- Table structure for table `org_recent_activities`
--

CREATE TABLE `org_recent_activities` (
...
--
-- Dumping data for table `org_recent_activities`
--

INSERT INTO `org_recent_activities` (`activity_id`, `organization_id`, `user_id`, `document_id`, `activity_type`, `description`, `created_at`) VALUES
(2, 1, 1, 52, 'Document Created', 'acad lead created document \'withtracking.pdf\'.', '2025-10-13 13:52:36'),
(3, 1, 1, 52, 'Document Updated', 'acad lead updated document \'withtracking.pdf\'.', '2025-10-13 13:53:00'),
(4, 1, 1, 52, 'Document Submitted', 'acad lead submitted document \'withtracking.pdf\' for review.', '2025-10-13 13:56:52'),
(9, 1, 1, 50, 'Document Deleted', 'acad lead deleted the document \'samle.pdf\'.', '2025-10-13 14:18:01'),
(10, 1, 8, 44, 'Document Updated', 'sample asdad updated document \'futures.pdf\'.', '2025-10-13 15:45:30'),
(11, 1, 1, 44, 'Document Updated', 'acad lead updated document \'futures.pdf\'.', '2025-10-14 02:38:29');
...
INSERT INTO `supporting_documents` (`support_doc_id`, `document_id`, `file_name`, `file_path`, `uploaded_at`, `notes_summary`) VALUES
(6, 45, 'esigtry-12.pdf', '../function/org/uploads/pdfs/cc8213fed51eb97327abcd6af9ba21e3.pdf', '2025-10-01 01:39:34', NULL),
(7, 45, 'page-export-33.pdf', '../function/org/uploads/pdfs/56bc081d207505502a5c508f9caaa248.pdf', '2025-10-01 01:39:34', NULL),
(8, 44, 'document_44.pdf', '../function/org/uploads/pdfs/a1ec750a98dcb65770ca1dae84a0b50f.pdf', '2025-10-14 02:38:29', NULL),
(9, 44, 'document_48-1.pdf', '../function/org/uploads/pdfs/6d4953da9cd8e77d87bf9afbcee841e5.pdf', '2025-10-14 02:38:29', NULL),
(11, 44, 'dsh-1.pdf', '../function/org/uploads/pdfs/7345795e51e602d2892d594c6945fc5c.pdf', '2025-10-14 02:42:33', '');
...
INSERT INTO `users` (`user_id`, `e_signature_path`, `first_name`, `last_name`, `email`, `password_hash`, `rank_id`, `user_role`, `organization_id`, `signature_base_code`, `reset_code`) VALUES
(1, NULL, 'acad', 'lead', 'acadlead@gmail.com', '$2y$10$2fVoxKJxAbDeM85eQdvjT.dMLtF7GV4HSzNvNThDJMK2N3ZhKjswq', 5, 'academic_organization', 1, NULL, 'VSNQUPBAJ9'),
(8, NULL, 'sample', 'asdad', 'sample@gmail.com', '$2y$10$x8CkTfCkbJFKJhQdav5OyO0/waIwHE3R.HYorTyFgw21pP/2DITzW', 1, 'academic_organization', 1, NULL, ''),
...
ALTER TABLE `documents`
  ...
  ADD KEY `documents_ibfk_4` (`updated_by`);
...
ALTER TABLE `document_access`
  ...
  ADD UNIQUE KEY `doc_user_unique` (`document_id`,`user_id`),
  ADD KEY `user_id` (`user_id`),
...
ALTER TABLE `events`
  ...
  ADD KEY `events_ibfk_4` (`updated_by`);
...
--
-- Indexes for table `org_recent_activities`
--
ALTER TABLE `org_recent_activities`
  ADD PRIMARY KEY (`activity_id`),
  ADD KEY `fk_org_activities_org` (`organization_id`),
  ADD KEY `fk_org_activities_user` (`user_id`),
  ADD KEY `fk_org_activities_document` (`document_id`);
...
--
-- AUTO_INCREMENT for table `org_recent_activities`
--
ALTER TABLE `org_recent_activities`
...
--
ALTER TABLE `supporting_documents`
  MODIFY `support_doc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
ALTER TABLE `documents`
  ...
  ADD CONSTRAINT `documents_ibfk_4` FOREIGN KEY (`updated_by`) REFERENCES `users` (`user_id`) ON DELETE SET NULL;

--
-- Constraints for table `document_access`
--
ALTER TABLE `document_access`
  ADD CONSTRAINT `document_access_ibfk_1` FOREIGN KEY (`document_id`) REFERENCES `documents` (`document_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `document_access_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `document_access_ibfk_3` FOREIGN KEY (`granted_by_user_id`) REFERENCES `users` (`user_id`) ON DELETE NO ACTION;
...
ALTER TABLE `events`
  ...
  ADD CONSTRAINT `events_ibfk_4` FOREIGN KEY (`updated_by`) REFERENCES `users` (`user_id`) ON DELETE SET NULL;
...
--
-- Constraints for table `org_recent_activities`
--
ALTER TABLE `org_recent_activities`
  ADD CONSTRAINT `fk_org_activities_document` FOREIGN KEY (`document_id`) REFERENCES `documents` (`document_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_org_activities_org` FOREIGN KEY (`organization_id`) REFERENCES `organizations` (`organization_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_org_activities_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL;
