		...
		<nav class="sidebar d-flex flex-column flex-shrink-0 position-fixed">
			...
			<div class="scroll">
				<div class="nav flex-column ">
					...
					<hr class="hr p-0 m-0 ">
					<a href="org-sig.php" class="sidebar-link active text-decoration-none px-3 py-1">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6 pb-3 ps-3">		
										<div class="dropdown">
											<button type="button" class="btn background dropdown-toggle" data-bs-toggle="dropdown" style="background-color:  white; border: 1px solid black;">
												Organization Type	
											</button>
											<ul class="dropdown-menu">
												<li><a class="dropdown-item" href="#" >Academic Organization</a></li>
												<li><a class="dropdown-item" href="#">Non-Academic Organization</a></li>
											</ul>
										</div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row px-3">                        
                                            <div class="col-md-2 d-flex org-card justify-content-center mb-3">
                                                <a href=""> 
                                                    <div class="card shadow">
                                                        <div class="card-body px-3  py-1">
                                                            <img src="../../img/logo/ages.png" class="img-org">
                                                            <hr class="m-1 p-0">
                                                            <p class="m-0 text-center">AGES</p>
