		...
		<nav class="sidebar d-flex flex-column flex-shrink-0 position-fixed">
			...
			<div class="scroll">
				<div class="nav flex-column ">
					...
					<a href="templates-sig.php" class="sidebar-link  active text-decoration-none px-3 py-1">
					...
					<a href="pending_events-sig.php" class="sidebar-link text-decoration-none px-3 py-1">
					...
					<a href="manage-acc-sig.php" class="sidebar-link  text-decoration-none px-3 py-1">
