		...
		<nav class="sidebar d-flex flex-column flex-shrink-0 position-fixed">
			...
			<div class="scroll">
				<div class="nav flex-column ">
					...
					<a href="manage-acc-sig.php" class="sidebar-link active text-decoration-none px-3 py-1">
									...
									<div class="card">
										<div class="card-header text-center">
											<h5 class="mb-0 fw-bold text-black">
												<i class="bi bi-pencil-square me-2"></i>EDIT MY ACCOUNT
											</h5>
										</div>
										<div class="card-body">
											<form>
											...
											<h5 class="text-center mt-4 mb-3">Change your password</h5>
											<div class="mb-3">
												...
												<div class="mb-3">
												<label for="newPassword" class="form-label fw-bold">Confirm password</label>
