		...
		<nav class="sidebar d-flex flex-column flex-shrink-0 position-fixed">
			...
			<div class="scroll">
				<div class="nav flex-column ">
					<a href="dash-adviser.php" class="sidebar-link text-decoration-none px-3 py-1">
					...
					<a href="templates-adviser.php" class="sidebar-link  active text-decoration-none px-3 py-1">
					...
					<a href="manage-acc-adviser.php" class="sidebar-link  text-decoration-none px-3 py-1">
                                        ...
                                        <tr>
                                            ...
                                            <td  class="d-flex justify-content-around ">
                                                <div class="row  p-0 m-0">
                                                    <div class="col-6 p-0" >
                                                        <a href="" class="">
                                                            <button type="submit" name="editcourse" id="editcourse" class="btn bg-info text-light py-0 px-2" style="height: 30px; width:60px;">  
                                                            View</button>
                                                        </a>
                                                    </div>
                                                    <div class="col-6 p-0">
                                                        <a href="" class="">
                                                            <button type="submit" name="editcourse" id="editcourse" class="btn bg-success text-light py-0 px-2" style="height: 30px; width:100px;">  
                                                            Download</button>
                                                        </a>
                                                    </div>
                                                </div>
