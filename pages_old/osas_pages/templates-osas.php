...
<!-- 
			...
			<div class="scroll">
				<div class="nav flex-column ">
					<a href="dash-osas.php" class="sidebar-link text-decoration-none px-3 py-1">
					...
					<hr class="hr p-0 m-0 ">
					<a href="templates-osas.php" class="sidebar-link active text-decoration-none px-3 py-1">
									...
									<!-- <div class="col-12">
										<div class="row">				
											<div class="col-3 p-1 d-flex  justify-content-center">
												<button type="button" class="btn btn-outline-success" style="width: 100%;">Accreditation Forms</button>
											</div>
											<div class="col-3 p-1 d-flex justify-content-center">
												<button type="button" class="btn btn-outline-success" style="width: 100%;">Off-Campus Activities Forms</button>
											</div>
											<div class="col-3 p-1 d-flex justify-content-center">
												<button type="button" class="btn btn-outline-success" style="width: 100%;">Proposed Activities Forms</button>
											</div>
											<div class="col-3 p-1 d-flex justify-content-center">
												<button type="button" class="btn btn-outline-success" style="width: 100%;">Recognition Forms</button>
											</div>
										</div>
									</div> -->
								</div>
                                <table id="myTable" class="display">
                                    <thead class="pt-3">
                                        <tr class="pt-3 bg-secondary-subtle">
                                            ...
                                            <th style="width:200px;">File Type</th>
                                            ...
                                            <td  class=" ">
                                                <div class="row d-flex justify-content-between p-0 m-0">
													...
													<div class="col-4 d-flex justify-content-center p-0" >
                                                        <a href="" class="">
                                                            <button type="submit" name="editcourse" id="editcourse" class="btn bg-primary text-light py-0 px-2" style="height: 30px;">  
                                                            <i class="fa-solid fa-eye"></i></button>
                                                        </a>
                                                    </div>
                                                    <div class="col-4 d-flex justify-content-center p-0">
                                                        <a href="" class="">
                                                            <button type="submit" name="editcourse" id="editcourse" class="btn bg-success text-light py-0 px-2" style="height: 30px; ">  
                                                            <i class="fa-solid fa-pen-to-square"></i></button>
                                                        </a>
                                                    </div>
                                                    <div class="col-4 d-flex justify-content-center p-0">
                                                        <a href="" class="">
                                                            <button type="submit" name="editcourse" id="editcourse" class="btn bg-danger text-light py-0 px-2" style="height: 30px; ">  
				...
				<div class="modal-dialog modal-dialog-centered">
					<form class="modal-content" action="../../function/function.php" method="POST" enctype="multipart/form-data">
						...
						<div class="modal-header">
							<h5 class="modal-title" id="addOfficerModalLabel">Add Template</h5>
							<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
						</div>
						<div class="modal-body">
							<div class="form-floating mb-3">
								<input type="text" class="form-control" id="floatingFolder" name="file_name" placeholder="File Name" required>
								<label for="floatingFolder" class="form-label">File Name</label>
							</div>
							<div class="mb-3">
						...
						<div class="modal-footer">
							...
							<button type="submit" class="btn btn-primary" name="add-template">Add</button>
						</div>
					</form>
				</div>
			</div>
