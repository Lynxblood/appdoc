...
<?php
  require '../../config/dbcon.php';
    ...
    // Fetch all templates to display in the table
    $stmt = $conn->prepare("SELECT template_id, template_name, created_at FROM templates ORDER BY created_at DESC");
    $stmt->execute();
...
<body>
						...
						<tbody >
                            <?php foreach ($templates as $template): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars(formatDateTime($template['created_at'])); ?></td>
                                    <td>
                                        <div class="btn-group dropstart">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item edit-template" href="#" data-id="<?php echo $template['template_id']; ?>">Edit</a></li>
                                                <li><a class="dropdown-item delete-template" href="#" data-id="<?php echo $template['template_id']; ?>" >Delete</a></li>
                                            </ul>	
                                        </div>
                                    </td>
                                </tr>
		...
		<div class="modal fade" id="templateModal" tabindex="-1" aria-labelledby="templateModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
				...
				<div class="modal-header">
					<h1 class="modal-title fs-5" id="templateModalLabel">Create new template</h1>
                ...
                <form id="templateForm" method="POST">
                                ...
                                <div class="col-lg-4">
                                    <div id="controlPanel" class=" panel">
                                        <!-- <div class="mb-2">
                                            ...
                                            <select id="templateSelect" name="document_type" class="form-select">
                                ...
                                <div class="col-lg-8">
                                    <div class="panel d-flex flex-column">
                                        <div class="d-flex align-items-center border-bottom mb-3 pb-2">
                                            ...
                                            <input id="templateName" name="template_name" value="page-export.pdf" class="filename-input">
                                        </div>
                                        
                                        <textarea id="editorTemplateContent" name="content_html" hidden></textarea>
                                        <div id="editorTemplate" contenteditable="true">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success basc-green-button">Save template</button>
                    </div>
                </form>
				</div>
			</div>
            ...
            <div class="modal fade" id="viewTemplateModal" tabindex="-1" aria-labelledby="viewTemplateModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="viewTemplateModalLabel">View template</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <iframe id="viewTemplateContent" src="" style="width:100%;height:80vh;border:none;"></iframe>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    </div>
	...
	<script>
        ...
        document.getElementById('exportPdfBtn').addEventListener('click', async () => {
            try {
                const content = document.getElementById('editorTemplate').innerHTML;
    ...
    <script>
        $(document).ready(function() {
            $('#templateForm').on('submit', function(e) {
                ...
                if (templateName === "") {
                    alertify.error("Template name cannot be empty.");
                    return; // Stop the function from proceeding
                }

                $('#editorTemplateContent').val($('#editorTemplate').html());
                
                $.ajax({
                    url: '../function/org/save_template.php',
                    type: 'POST',
                    data: $(this).serialize(),
            ...
            $('#templateModalButton').on('click', function() {
                ...
                $('#templateModalLabel').text('Create New Template');
            });
            ...
            $(document).on('click', '.edit-template', function(e) {
                ...
                $.post('../function/org/get_template.php', { id: templateId }, function(data) {
                    if (data.success) {
                        ...
                        $('#editorTemplate').html(data.content_html);
            ...
            $(document).on('click', '.delete-template', function(e) {
                ...
                alertify.confirm("Delete Template", "Are you sure you want to delete this template?", 
                    function() {
                        $.post('../function/org/delete_template.php', { id: templateId }, function(data) {
                            if (data.success) {
