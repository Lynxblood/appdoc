...
<body>
			...
			<div class="container-fluid">
				<div class="container-fluid rounded-3 border border-secondary-subtle p-3 my-3">
					...
					<table id="myTable" class="table table-striped text-start">
						...
						<tbody>
							<?php
							$sql = "SELECT * FROM documents WHERE status = 'submitted'";
										...
										echo '<td>
												<div class="btn-group dropstart">
													...
													<ul class="dropdown-menu">
														<li><a class="dropdown-item approve-pdf" href="#" data-id="'. $row['document_id'] .'" data-bs-toggle="modal" >Endorse</a></li>
		...
		<div class="modal fade" id="returnApplication" tabindex="-1" aria-labelledby="returnApplicationLabel" aria-hidden="true">
			<div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
				...
				<div class="modal-header">
					...
					<form id="editorForm" method="POST" action="../function/adviser/return.php">
		...
		<div class="modal fade" id="uploadSignatureModal" tabindex="-1" aria-labelledby="uploadSignatureModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form id="uploadSignatureForm" method="POST" action="../function/adviser/e_signature_upload.php" enctype="multipart/form-data">
						<div class="modal-body">
							<!-- Bootstrap Dropzone with Preview + Controls -->
							...
							<label for="signatureImage" 
								...
								<input id="signatureImage" name="signatureImage" type="file" class="d-none" accept="image/*" />
							</label>
							</div>
						</div>
						<div class="modal-footer">
	...
	<script>
		...
		document.addEventListener("DOMContentLoaded", () => {
		  document.querySelectorAll(".view-pdf").forEach(btn => {
			btn.addEventListener("click", () => {
			  ...
			  document.getElementById("pdfFrame").src = "../function/adviser/view.php?id=" + id;
			});
		  });
		});
		...
		document.querySelectorAll(".approve-pdf").forEach(btn => {
			...
			xhr.open("POST", "../function/adviser/submitpdf.php", true);
			...
			xhr.send("id=" + encodeURIComponent(id) + "&status=endorsed"); 
			});
		});
		});
		...
		$(document).on("click", ".return-pdf", function(e) {
			...
			$.post("../function/adviser/get_document.php", { id: docId }, function(data) {
				if (data.success) {
		...
		$("#editorForm").on("submit", function(e) {
			...
			$.post("../function/adviser/return.php", {
				id: docId,
		...
		$(document).on("click", ".delete-pdf", function(e) {
			...
			alertify.confirm("Delete Document", "Are you sure you want to delete this document? This action cannot be undone.", 
				function() { // OK button callback
					$.post("../function/adviser/delete_document.php", { id: docId }, function(data) {
						if (data.success) {
							alertify.success(data.message);
		...
		$("#submitCommentBtn").on("click", function() {
			...
			$.post("../function/adviser/save_comment.php", {
				document_id: docId,
        ...
        alertify.confirm("Delete Comment", "Are you sure you want to delete this comment?", 
            function() { // OK button callback
                $.post("../function/adviser/delete_comment.php", { comment_id: commentId }, function(data) {
                    if (data.success) {
                        alertify.success(data.message);
