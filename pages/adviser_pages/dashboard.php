<?php
  require '../../config/dbcon.php';
    ...
    $query_pending = "SELECT COUNT(*) AS total_pending FROM documents WHERE status = 'submitted'";
    ...
    $query_recent_activity = "
        ...
        WHERE u.user_id = $adviser_id -- Filter for actions taken by the current adviser
    ...
    $query_notifications = "
        ...
        JOIN organizations o ON d.organization_id = o.organization_id
        WHERE n.user_id = $adviser_id -- Target the current adviser
...
<body>
    <?php
    include '../Components/sidebar.php'; // DO NOT REMOVE
    ?>
                                            ...
                                            <?php if ($result_pending_table->num_rows > 0): ?>
                                                <?php while ($doc = $result_pending_table->fetch_assoc()): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="../function/adviser/view.php?id=<?= $doc['document_id']; ?>" class="btn btn-sm btn-primary">Review</a>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
                                            <?php endif; ?>
