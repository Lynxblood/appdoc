...
// Fetch document and organization data with a single query
$stmt = $conn->prepare("SELECT d.pdf_filename, d.content_html, o.logo FROM documents d JOIN organizations o ON d.organization_id = o.organization_id WHERE d.document_id = ?");
...
try {
    ...
    // Paths to images (Left logo is static, Right logo is now dynamic)
    $logoLeft = '../../../img/logo/basc_logo.png';
    $logoRight = $organization_logo ? '../../../' . $organization_logo : '../../../img/logo/bits.png'; // Use a default if no logo is found

    $footerLeft = '../../../img/logo/iso9001.png';
    $footerRight= '../../../img/logo/bagongphil.png';

    // Header HTML with dynamic logo
    $headerHtml = '
    ...
    // Show inline instead of download
