            ...
            <div class="row">
                ...
                <div class="col-lg-6 settings-card">
                    <div class="panel">
                        ...
                        <form id="changePasswordForm" method="POST" action="../function/fssc/change_password.php">
    ...
    <div class="modal fade" id="uploadSignatureModal" tabindex="-1" aria-labelledby="uploadSignatureModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="uploadSignatureForm" method="POST" action="../function/fssc/e_signature_upload.php" enctype="multipart/form-data">
