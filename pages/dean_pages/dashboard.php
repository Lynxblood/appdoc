<?php
  require '../../config/dbcon.php';
    ...
    $query_recent_activity = "
        ...
        WHERE u.user_id = $dean_id -- Filter for actions taken by the current adviser
    ...
    $query_notifications = "
        ...
        JOIN organizations o ON d.organization_id = o.organization_id
        WHERE n.user_id = $dean_id -- Target the current adviser
                                            ...
                                            <?php if ($result_pending_table->num_rows > 0): ?>
                                                <?php while ($doc = $result_pending_table->fetch_assoc()): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="../function/dean/view.php?id=<?= $doc['document_id']; ?>" class="btn btn-sm btn-primary">Review</a>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
                                            <?php endif; ?>
